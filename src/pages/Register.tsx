    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-violet-50 via-purple-50 to-violet-100 dark:from-gray-900 dark:via-violet-950 dark:to-purple-950">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          className="absolute -top-1/2 -right-1/2 w-full h-full bg-gradient-to-bl from-violet-500/20 to-purple-500/20 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1.2, 1, 1.2],
          ...
          transition={{ duration: 20, repeat: Infinity, ease: 'linear' }}
          className="absolute -bottom-1/2 -left-1/2 w-full h-full bg-gradient-to-tr from-purple-500/20 to-violet-500/20 rounded-full blur-3xl"
        />
      </div>
      ...
      >
        ...
        >
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">Registrate para analizar proyectos de ley</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-muted-foreground">
              ¿Ya tienes cuenta?{' '}
              <Link to="/login" className="text-violet-600 hover:text-violet-700 dark:text-violet-400 dark:hover:text-violet-300 transition-colors font-medium">
                Inicia sesión
              </Link>
            </p>
          </div>
